defmodule Simulation do
    ...
    def simulate(total) do
            ...
            :ets.insert(:staticFields, {"sampleTweets", ["Today is dec 13th. ","It's the last submission of Dos. ","Christmas Holidays","It's a party time. ","new year 2020. "]})
            :ets.insert(:staticFields, {"hashTags", ["#13th ","#Dos ","#Christmas ","#party ","#2020 "]})
    ...
    def start_Client([client | numClients], mapOfSockets) do
            ...
            push socket, "registeration", payload
    ...
    def generateMultipleTweets(username, socket, delay) do
                ...
                content = Simulation.getTweetContent(username)
                # IO.inspect content
